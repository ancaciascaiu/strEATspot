...
Vendor.create(username:  "Avnerosmith's Banana Blitz", email:  "banana@blitz.com", password: "banana", schedule: "M-F 8-3, S,S 10-10", latitude: 41.887874, longitude: -87.648083)
...
Vendor.create(username:  "3 Duke's Greene's", email:  "duke@greene.ss", password: "banana", schedule: "M-F 10-6, S,S 8-7", latitude: 41.878644, longitude: -87.631303)
...
Vendor.create(username: "My Taco Truck", email: "taco@truck.com", password: "banana", schedule: "W-F 8-5, S,S 11-4", latitude: 41.900004, longitude: -87.631233)
Vendor.create(username: "West's East Side, Boat Side Smoothies", email: "west@smoothies.com", password: "banana", schedule: "W-F 8-5, S,S 11-4", latitude: 41.878774, longitude: -87.653333)
Vendor.create(username: "Tory's Tortillas", email: "tory@tortillas.com", password: "banana", schedule: "W-F 8-5, S,S 11-4", latitude: 41.895199, longitude: -87.644053)
